        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-neutral-800">
          ...
          <div className="mt-4 flex items-center gap-3 px-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-white truncate">Kurt Nielsen</p>
              <p className="text-xs text-neutral-500 truncate">Property Manager</p>
            </div>
          </div>
        </div>
      </aside>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <input
                type="text"
                placeholder="Search..."
                className="w-64 pl-10 pr-4 py-2 bg-neutral-100 border-0 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
              />
